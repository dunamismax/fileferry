                ...
                <main id="main">
                    <section class="hero" aria-labelledby="hero-title">
                        ...
                        <div class="hero-shell">
                            <p class="eyebrow">"fileferry.app"</p>
                    ...
                    <section class="section operator-section" id="operators" aria-labelledby="operators-title">
                        <div class="section-heading compact">
                            ...
                            <p>
                                "FileFerry is not trying to become a dashboard, daemon, scheduler, server, mount layer, or compatibility shim. The product center is encrypted backup and reliable restore from a local or S3-compatible repository."
                            </p>
                        </div>
                    ...
                    <section class="section release" aria-labelledby="release-title">
                        ...
                        <div class="deploy">
                            <span>"Binary"</span>
                            <code>"fileferry-web"</code>
                            <span>"Default bind"</span>
                            <code>"0.0.0.0:8080"</code>
                            <span>"Override"</span>
                            <code>"FILEFERRY_WEB_ADDR=127.0.0.1:8080"</code>
                        </div>
                    </section>
                </main>
                <footer>
