...
`ferry restore`, `ferry check`, `ferry forget`, `ferry prune`, and
...
for providers beyond the current Backblaze B2 path, live-S3 `ferry find`
drill coverage, partial upload behavior, and multipart cleanup guidance.
