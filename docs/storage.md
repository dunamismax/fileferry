...
`ferry diff`, `ferry repo`, `ferry doctor`, `ferry restore`, `ferry check`,
`ferry forget`, `ferry prune`, `ferry policy ...`, and `ferry key ...`
commands accept S3-compatible repository URLs in this form:
...
`ferry init`, `ferry backup`, `ferry snapshots`, `ferry ls`, `ferry find`,
`ferry diff`, `ferry repo`, `ferry doctor`, `ferry restore`, `ferry check`,
`ferry forget`, `ferry prune`, `ferry policy ...`, and `ferry key ...` commands use
S3-compatible encrypted repositories through the same core repository pipeline
